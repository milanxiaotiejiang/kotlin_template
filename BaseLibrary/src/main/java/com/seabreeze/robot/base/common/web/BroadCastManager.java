...
public class BroadCastManager {
    ...
    private static final String EXTRA_PROGESS = "EXTRA_PROGESS";
    private static final String EXTRA_PRECOMPOSED = "EXTRA_PRECOMPOSED";
    private static final String EXTRA_USER_AGENT = "EXTRA_USER_AGENT";
    ...
    private static final String EXTRA_CONTENT_LENGTH = "EXTRA_CONTENT_LENGTH";

    protected int key;
    private List<WebViewListener> listeners;
